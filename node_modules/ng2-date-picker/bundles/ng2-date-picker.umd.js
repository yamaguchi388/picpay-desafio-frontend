(function (global, factory) {
...
})(this, (function (exports, i0, forms, common, moment) { 'use strict';
    ...
    DomHelper.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function DomHelper_Factory() { return new DomHelper(); }, token: DomHelper, providedIn: "root" });
    ...
    var UtilsService = /** @class */ (function () {
        ...
        UtilsService.prototype.convertToMoment = function (date, format) {
            if (!date) {
                ...
                return moment__namespace(date, format);
            }
            else {
                return date.clone();
            }
        ...
        UtilsService.prototype.isDateValid = function (date, format) {
            ...
            return moment__namespace(date, format, true).isValid();
        };
        // todo:: add unit test
        UtilsService.prototype.getDefaultDisplayDate = function (current, selected, allowMultiSelect, minDate) {
            ...
            else if (minDate && minDate.isAfter(moment__namespace())) {
        ...
        UtilsService.prototype.getInputType = function (value, allowMultiSelect) {
            if (Array.isArray(value)) {
                ...
                else if (moment__namespace.isMoment(value[0])) {
                    return exports.ECalendarValue.MomentArr;
                }
            }
            else {
                ...
                else if (moment__namespace.isMoment(value)) {
        ...
        UtilsService.prototype.convertToMomentArray = function (value, config) {
            ...
            switch (this.getInputType(value, config.allowMultiSelect)) {
                case (exports.ECalendarValue.String):
                    retVal = value ? [moment__namespace(value, config.format, true)] : [];
                    break;
                case (exports.ECalendarValue.StringArr):
                    retVal = value.map(function (v) { return v ? moment__namespace(v, config.format, true) : null; }).filter(Boolean);
                    break;
        ...
        UtilsService.prototype.onlyTime = function (m) {
            return m && moment__namespace.isMoment(m) && moment__namespace(m.format('HH:mm:ss'), 'HH:mm:ss');
        };
        ...
        UtilsService.prototype.getValidMomentArray = function (value, format) {
            ...
            return this.datesStringToStringArray(value)
                ...
                .map(function (d) { return moment__namespace(d, format); });
        };
        UtilsService.prototype.shouldShowCurrent = function (showGoToCurrent, mode, min, max) {
            return showGoToCurrent &&
                mode !== 'time' &&
                this.isDateInRange(moment__namespace(), min, max);
        };
    ...
    var DayCalendarService = /** @class */ (function () {
        function DayCalendarService(utilsService) {
            ...
            this.DEFAULT_CONFIG = {
                ...
                locale: moment__namespace.locale(),
                dayBtnFormat: 'DD',
        ...
        DayCalendarService.prototype.getConfig = function (config) {
            ...
            moment__namespace.locale(_config.locale);
            return _config;
        };
        ...
        DayCalendarService.prototype.generateMonthArray = function (config, month, selected) {
            var _this = this;
            var parsedMonth = month.isValid() ? month.clone() : moment__namespace();
            var monthArray = [];
            var firstDayOfWeekIndex = this.DAYS.indexOf(config.firstDayOfWeek);
            var firstDayOfBoard = parsedMonth.clone().startOf('month');
            while (firstDayOfBoard.day() !== firstDayOfWeekIndex) {
                firstDayOfBoard.subtract(1, 'day');
            }
            var current = firstDayOfBoard.clone();
            var prevMonth = parsedMonth.clone().subtract(1, 'month');
            var nextMonth = parsedMonth.clone().add(1, 'month');
        ...
        DayCalendarService.prototype.generateWeekdays = function (firstDayOfWeek) {
            var weekdayNames = {
                su: moment__namespace().day(0),
                mo: moment__namespace().day(1),
                tu: moment__namespace().day(2),
                we: moment__namespace().day(3),
                th: moment__namespace().day(4),
                fr: moment__namespace().day(5),
                sa: moment__namespace().day(6)
            };
            var weekdays = [];
    ...
    var DayTimeCalendarService = /** @class */ (function () {
        ...
        DayTimeCalendarService.prototype.getConfig = function (config) {
            ...
            moment__namespace.locale(config.locale);
            return _config;
        };
        DayTimeCalendarService.prototype.updateDay = function (current, day, config) {
            var time = current ? current : moment__namespace();
            var updated = moment__namespace(day.format(DAY_FORMAT) + time.format(TIME_FORMAT), COMBINED_FORMAT);
            if (config.min) {
                var min = config.min;
        ...
        DayTimeCalendarService.prototype.updateTime = function (current, time) {
            var day = current ? current : moment__namespace();
            return moment__namespace(day.format(DAY_FORMAT) + time.format(TIME_FORMAT), COMBINED_FORMAT);
        };
    ...
    var DayCalendarComponent = /** @class */ (function () {
        ...
        DayCalendarComponent.prototype.goToCurrent = function () {
            this.currentDateView = moment__namespace();
            ...
            return this.utilsService.createArray(config.numOfMonthRows).map(function () {
                return _this.utilsService.createArray(12 / config.numOfMonthRows).map(function () {
                    ...
                    var month = {
                        ...
                        currentMonth: index.isSame(moment__namespace(), 'month'),
    ...
    var TimeSelectComponent = /** @class */ (function () {
        ...
        TimeSelectComponent.prototype.init = function () {
            ...
            this.selected = this.selected || moment__namespace();
